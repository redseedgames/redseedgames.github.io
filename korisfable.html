...
<head>
  ...
  <meta name="description" content="Action, adventure and romance visual novels and turn based games.">
...
<div class="container-fluid" style="margin-top:30px;">
	  ...
	  <div class="col-sm-6">
	  <p id = "home"></p><br><br>
	  <img src = "images/koris_fable_text.png" class="img-fluid"><br>
	  <h2 style = "text-shadow: 0 0 5px #FFFFFF;font-family:binary;">IN A WORLD OF TWISTED MAGIC AND BROKEN SPIRITS BE A GIRL WITH A MISSION</h2>
	  <br><br>
	  <center>
	  <h2 style = "text-shadow: 0 0 5px #FFFFFF;font-family:binary;">AVAILABLE ON:</h2>
	  </center>
	  
	  <!--Google Play and Itch.io button images-->
	  <center>
	  <div class = "d-inline"><a href = "https://play.google.com/store/apps/details?id=cc.redseed.korisfable"><img src = "images/google-play-badge.png" style = "margin-right:10px;margin-top:10px;width:200px;height:auto;"/></a>
	  <a href = "https://redseedgames.itch.io/koris-fable"><img src = "images/itch_badge.png" style = "width:200px;height:auto;margin:10px;"/></a>
    <a href = "https://store.steampowered.com/app/2280260/Koris_Fable_Visual_Novel/"><img src = "images/steam.jpg" style = "width:200px;height:auto;margin:10px;"/></a>
	  </div>
	  </center>
	  ...
	  <p id = "about"></p><br><br>
	  <h1 style="text-shadow: 0 0 10px white;font-family:binary;color:white;font-size:60px;">ABOUT</h1>
	  <br><br>
	  <div class = "row">
	  <div class = "col-sm-6">
	  ...
	  <div class = "col-sm-6">
	  <h2 style = "text-shadow: 0 0 5px #FFFFFF;font-family:binary;">IN THE CONTINENT OF HIGH BIRM THE PRIESTS HELD THE HIGHEST POWER.
	  THE KINGDOMS IN THE CONTINENT TOOK COUNSEL FROM THEIR HIGH PRIESTS AND RULED WITH AN IRON FIST.
	  ON TOP OF THAT THE MINGLING OF GODLY MAGIC AND SORCERY HAD CREATED MANY TWISTED SPELLS AND FORBIDDEN ARTS IN THIS LAND.</h2>
	  </div>
	  </div>
	  <hr style="border: 2px solid white;padding-bottom:0px;margin-bottom:0px;padding-top:0px;margin-top:0px;">
	  <div class = "row">
	  <div class = "col-sm-8">
	 <h1 style="text-shadow: 0 0 10px white;font-family:binary;color:white;font-size:60px;">SCREENS</h1>
  ...
  <div class="carousel-inner" role="listbox">
    <div class="carousel-item active">
      <img class="d-block img-fluid" src="images/koris_fable_screenshot_3_compressed.jpg">
    </div>
    <div class="carousel-item">
      <img class="d-block img-fluid" src="images/koris_fable_screenshot_2_compressed.jpg">
    </div>
    <div class="carousel-item">
      <img class="d-block img-fluid" src="images/koris_fable_screenshot_1_compressed.jpg">
    </div>
	<div class="carousel-item">
      <img class="d-block img-fluid" src="images/koris_fable_screenshot_4_compressed.jpg">
    </div>
	<div class="carousel-item">
      <img class="d-block img-fluid" src="images/koris_fable_screenshot_5_compressed.jpg">
    </div>
	<div class="carousel-item">
      <img class="d-block img-fluid" src="images/koris_fable_screenshot_6_compressed.jpg">
    </div>
	<div class="carousel-item">
      <img class="d-block img-fluid" src="images/koris_fable_screenshot_7_compressed.jpg">
    </div>
...
AMONG ALL THIS A SWEET GIRL NAMED KORI LOST HER PARENTS WHEN THEY WERE TAKEN PRISONERS BY THE KINGDOM OF HER LAND.<br>
...
<hr style="border: 2px solid white;padding-bottom:0px;margin-bottom:0px;padding-top:0px;margin-top:0px;">
 <p id = "contactus"></p><br><br>
	  <div class = "row">
	  <div class = "col-sm-4">
	  <h1 style="text-shadow: 0 0 10px white;font-family:binary;color:white;font-size:60px;">CONTACT US</h1>
	  <br><br>
...
<a href = "https://www.tumblr.com/blog/redseedgames"><img src = "https://ayushraj1024.files.wordpress.com/2019/03/if_tumblr_2308134.png"/></a>
  ...
  <div class = "row">
	  <div class = "col-sm-4">
    <h2 style = "text-shadow: 0 0 5px #FFFFFF;font-family:binary;">HERE IS A REVIEW FROM GAMESKEYS.NET</h2>
      <a href="https://gameskeys.net/android-games-to-tryout-in-march-2021/#D"><img src="https://a5r6m9a6.stackpathcdn.com/wp-content/uploads/2020/02/Games_Keys_logo-4.png" class="img-fluid"/>
      </a>
    </div>
    <div class="col-sm-4">
