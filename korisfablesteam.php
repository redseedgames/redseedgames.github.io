...
<div class="container-fluid" style="margin-top:30px;">
	  ...
	  <br><br>
	  <center>
	  <h2 style = "text-shadow: 0 0 5px #FFFFFF;font-family:binary;">COMING SOON ON:</h2>
	  </center>
	  
	  <!--Google Play and Itch.io button images-->
	  <center>
	  <div class = "d-inline"><!--<a href = "#"><img src = "images/google-play-badge.png" style = "margin-right:10px;margin-top:10px;width:300px;height:auto;"/></a>-->
	  <a href = "#"><img src = "images/steam.jpg" style = "width:300px;height:auto;margin:10px;"/></a>
	  </div>
	  </center>
